...
Pkg.add("NPFinancial"); Pkg.add("Distributions"); Pkg.add("DataStructures");Pkg.add("PlotlyJS"); Pkg.add("HTTP");Pkg.add("ReusePatterns");Pkg.add("ActuaryUtilities");
Pkg.add("TypeTree");Pkg.add("DataFrames");Pkg.add("JuliaDB")